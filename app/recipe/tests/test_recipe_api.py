...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_creste_recipe_with_existing_ingredient(self):
    ...
    def test_filter_by_tags(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Thai Vegtable Curry')
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title='Red Lentile Dal')
...
class ImageUploadTRests(TestCase):
